...
import img from '../assets/calor.jpg'
          ...
          >
            <>
              <Marker position={userPosition} options={{
                ...
                // icon={{
                //   url: img,
                //   size: new window.google.maps.Size(100, 100), // Tamanho absoluto do ícone
                //   scaledSize: new window.google.maps.Size(100, 100) // Tamanho de exibição do ícone
                // }}
              />
              {bairrosPerigosos.map((bairro, index) => {
                 return <Marker key={index} position={bairro} />
              })}
               {bairrosSeguros.map((bairro, index) => {
                 return <Marker key={index} position={bairro} />
              })}
            </>
